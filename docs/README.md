...
| Phase 8 selector | 新候选完整质量 A/B/A 已接受；NVFP4 辅助尺度迁移已修复，但逻辑路由稳定性 Gate 仍拒绝，禁止上线 | [暖态 placement 候选与质量验证报告](results/phase8_warm_placement_regeneration_20260823.md) |
