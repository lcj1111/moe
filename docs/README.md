...
| Phase 8 selector | v3 训练 Gate 已通过；独立900次测量完整，但 p95 regret 11.50% 超过10%门槛，禁止 canary | [独立 Gate 失败报告](results/phase8_selector_independent_gate_failed_20260823.md) |
...
最终独立结论见[独立 Gate 失败报告](results/phase8_selector_independent_gate_failed_20260823.md)。
