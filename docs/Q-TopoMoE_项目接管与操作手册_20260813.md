...
- `configs/communication/nccl_cost_db.json` 是当前唯一通信成本库。
...
2. 阅读[Phase 8 最终验收](results/phase8_warm_placement_final_acceptance_20260825.md)；
...
10. [Phase 8 最终验收](results/phase8_warm_placement_final_acceptance_20260825.md)；
