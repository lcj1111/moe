...
`docs/results/` 只保留当前聚合报告；实验合同有效但未通过 Gate 的叙述移入
`docs/archive/decision-history/`。输入无效的机器结果及其派生配置不进入归档和本清单。
# 2026-08-12 新增机器可读产物
...
| `configs/experiments/phase8_warm_placement_capture_v1.json` | identity 暖态逐层专家计数采集计划；正式有效结果来自独立 v3 输出目录。 | `D5F55D1A5200FD877E4F2666272FC87ED6C0F93C841C3E4ED86E6DD65FC4DB27` |
...
| `docs/results/phase8_warm_placement_regeneration_20260823.md` | 合并中文报告；记录当前 1% Gate 接受，并链接到最终验收。 | `57D55423D6DF3789DCD6EB34E07944024605857612D5985E259756A31D40CBA6` |
