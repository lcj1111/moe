...
| Phase 8 | selector 训练、900 次独立测试、one-shot、自动闭环与新 placement 重生成 | 旧闭环 Gate 保持拒绝；新候选降低 rank CV 且 p99 通过，但路由稳定性 Gate 拒绝，仍禁止上线 |
...
负载分布相对 identity 变化 14.28%，超过冻结稳定范围，因此新候选也未获准上线。
